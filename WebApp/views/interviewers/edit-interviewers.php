            ...
            <div class="row mb-0">
                <div class="col-md-12">
                    <div class="m-0 text-dark text-center text-lg">
                        <i class="fas fa-table"></i>&nbsp;&nbsp;Editar Encuestador
                    </div>
                </div>
            </div>
        </div>
                ...
                <form id="FRM_INSERT_PRODUCTO" method="post" action="<?php echo $funciones->direct_sistema(); ?>/modules/productos/insert-update-producto.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="list-pollsters" id="btn-save-product" class="btn btn-success btn-md btn-block"><i class="fa fa-check fa-1x"></i>&nbsp;&nbsp;<font>Guardar cambios</font></a>
                                </div>
                                <div class="col-md-6">
